...
# 方案 1：横向树形布局
png("C:/Users/Mr Zhou/Desktop/飞书智能化报告/SEM 路径图_横向.png", width=2000, height=1000, res=150)
semPaths(fit,
         what="std",
         layout="tree",
         edge.label.cex=0.7,
         ...
         rotation=1,
         mar=c(3,3,3,3),
         color=list(lat="lightblue", man="lightgreen", res="lightyellow"),
         edge.color="black",
         title=FALSE)
dev.off()

# 方案 2：圆形布局
png("C:/Users/Mr Zhou/Desktop/飞书智能化报告/SEM 路径图_圆形.png", width=1600, height=1200, res=150)
semPaths(fit,
         what="std",
         layout="circle",
         edge.label.cex=0.7,
         ...
         label.prop=0.5,
         mar=c(3,3,3,3),
         color=list(lat="lightpink", man="lightcyan", res="lightyellow"),
         edge.color="darkgray",
         title=FALSE)
dev.off()

cat("SEM 路径图已保存：\n")
cat("1. C:/Users/Mr Zhou/Desktop/飞书智能化报告/SEM 路径图_横向.png\n")
cat("2. C:/Users/Mr Zhou/Desktop/飞书智能化报告/SEM 路径图_圆形.png\n")
